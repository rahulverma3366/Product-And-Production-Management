...
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="assets/" data-template="vertical-menu-template">
   ...
   <body>
         ...
         <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
               <div class="w-px-400 mx-auto">
                  ...
                  <!-- /Logo -->
                  <h3 class="mb-1">Welcome to <?=business_name;?>! 👋</h3>
                  <p class="mb-4">Please sign-in to your account and start the adventure</p>
                  <form  class="mb-3  needs-validation" action="auth/login_action.php" method="POST" novalidate>
                     ...
                     <button name="submit" value="Login" class="btn btn-primary d-grid w-100">
                     Sign in
                     </button>
                  </form>
                  <p class="text-center">
                     <span>New on our platform?</span>
                     <a href="auth\auth-register.php" class="text-primary fw-medium">
      ...
      <script src="assets/js/pages-auth.js"></script>
        <script src="<?=website_name?>/assets/js/form-validation.js"></script>

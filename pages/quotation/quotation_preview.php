<?php 
   ...
   define('from', 'Quotation');
   define('to', ' Quotation Preview');
   ...
   if (empty($invoice_no)) {
     echo '<script>window.location.replace("quotations.php");</script>';
      ...
      $purchae_order = $db->query("SELECT * FROM `quotation` WHERE invoice_no = '$invoice_no' AND user_id = '$user_id'");
      $purchae_order_value = $purchae_order->fetch_object();
      $qt_id = $purchae_order_value->qt_id;
...
<!--                 <p class="mb-2 mt-3">
 ...
 -->                <span class="ms-3">Thanks for your business</span>
  ...
  <div class="col-xl-3 col-md-4 col-12 invoice-actions">
    <div class="card">
      <div class="card-body">
        <a class="btn btn-label-secondary d-grid w-100 mb-2" target="_blank" href="quotation_invoice_print?quotation_no=<?=$invoice_no;?>">
          Print
        </a>
      </div>
    </div>

  ...
  <div class="col-xl-3 col-md-4 col-12 invoice-actions">
    <div class="card">
      <div class="card-body">
        ...
        <a class="btn btn-label-secondary d-grid w-100 mb-2" target="_blank" href="invoice_print?invoice_no=<?=$invoice_no;?>&so_id=<?=$so_id;?>">
          Print
        </a>
        <a class="btn btn-label-primary d-grid w-100 mb-2" target="_blank" href="gst_invoice/invoice?invoice_no=<?=$invoice_no;?>&so_id=<?=$so_id;?>">
          GST Invoice
        </a>

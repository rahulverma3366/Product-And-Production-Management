                                    ...
                                    <div class="row" >
                                      ...
                                      <div class="col-md-12 mb-3">
                                       <label for="froms" > Select Devices</label>
                                        <select id="froms" name="imei_id[]" class="selectpicker " data-live-search="true" data-style="btn-default" data-max-options="<?=$limit;?>" multiple  >
                                          <option value="">Select Devices</option>
                                          <?php 
                                             $data = $db->query("SELECT * FROM `imei_update` WHERE sold = 0 AND p_id = '$product_id'");

<?php 
   ...
   $invoice_no = mysqli_real_escape_string($db,$_REQUEST['sale_print']);
   if (empty($invoice_no)) {
...
<body>
	...
	<div class="invoice_wrap agency1">
		<div class="invoice-container">
		    <div style="background:url('bg.png'); background-repeat: no-repeat; background-position:center; 
			 background-size: cover;">
			<div class="invoice-content-wrap" style=" background-repeat: no-repeat; background-position:center; 
			 ...
			 <div style="background-color: rgba(255, 255, 255, 0.731);">
				<header class="invoice-header "  id="invo_header">
					<div class="invoice-logo-content bg-black " style="background-color:<?php if($sto_id == 3){echo "rgb(183,162,82)";}else{echo "rgb(0,0,0)";}?>;">
            ...
            ?>
								...
								<table class="invo-total-table">
									<tbody>
										...
										<tr>
											...
											<td class="font-md-grey color-grey text-right pr-10 ">Rs <?php echo number_format($purchae_order_value->paid_amount);?></td>
										</tr>
										<tr class="tax-row">
											<td class="font-md color-light-black ">Due Amount</td>
											<td class="font-md-grey color-grey text-right pr-10 ">Rs <?php echo number_format($purchae_order_value->total - $purchae_order_value->paid_amount); ?></td>
										</tr>
					...
					<div class="agency-contact-sec bg-black" style="background-color:<?php if($sto_id == 3){echo "rgb(183,162,82)";}else{echo "rgb(0,0,0)";}?>;">

<?php 
   ...
   $invoice_no = mysqli_real_escape_string($db,$_REQUEST['pdac_id']);
   if (empty($invoice_no)) {
     echo '<script>window.location.replace("sale_invoice_list.php");</script>';
   }else{
      $user_id = $_SESSION['a_id'];
      $purchae_order1 = $db->query("SELECT * FROM `sales_due` WHERE pdac_id = '$invoice_no'");
      $purchae_order_value1 = $purchae_order1->fetch_object();
      $po_id1= $purchae_order_value1->po_id;
      $purchae_order = $db->query("SELECT * FROM `sales` WHERE po_id = '$po_id1' AND user_id = '$user_id'");
    ...
    <div class="card invoice-preview-card">
      <div class="card-body">
        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
          ...
          <div>
            <h4 class="fw-medium mb-2">Invoice #<?=$purchae_order_value->invoice_no;?>.<?=$purchae_order_value1->invoice_no?></h4>
            <div class="mb-2 pt-1">
...
<!--                 <p class="mb-2 mt-3">
 ...
 -->                <span class="ms-3">Thanks for your business</span>
              ...
              <td class="text-end pe-3 py-4">
                ...
                <p class="mb-2 pt-3">Paied Amount:</p>
              ...
              <td class="ps-2 py-4">
                ...
                <p class="fw-medium mb-2 pt-3">Rs <?php echo number_format($purchae_order_value1->amount); ?></p>
                <!-- <p class="fw-medium mb-2">$00.00</p> -->
                <p class="fw-medium mb-0 pb-3">Rs <?php echo number_format($purchae_order_value->total - $purchae_order_value1->amount); ?></p>
              </td>
            </tr>
          </tbody>
        </table>
  ...
  <div class="col-xl-3 col-md-4 col-12 invoice-actions">
    <div class="card">
      <div class="card-body">
        <a class="btn btn-label-secondary d-grid w-100 mb-2" target="_blank" href="newinvoice_print.php?pdac_id=<?=$invoice_no;?>">
          Print
        </a>
      </div>
    </div>
